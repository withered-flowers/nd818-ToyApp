...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        ...
        String theUrl = "https://www.udacity.com";

        // COMPLETED (6) Replace the Toast with a call to openWebPage, passing in the URL String from the previous step
        //Toast.makeText(this, "TODOlist: Open a web page when this button is clicked", Toast.LENGTH_SHORT).show();
        openWebPage(theUrl);
    }
