...
//    private static final String SEARCH_RESULTS_RAW_JSON = "results";
    ...
    private static final int GITHUB_SEARCH_LOADER = 400;
...
//            mSearchResultsTextView.setText(rawJsonSearchResults);
        ...
        getSupportLoaderManager()
            .initLoader(GITHUB_SEARCH_LOADER, null, this);
    }
...
//        new GithubQueryTask().execute(githubSearchUrl);
        ...
        Bundle queryBundler = new Bundle();
        queryBundler.putString(SEARCH_QUERY_URL_EXTRA, githubSearchUrl.toString());
        ...
        LoaderManager theLoaderManager = getSupportLoaderManager();
        Loader<String> theLoader = theLoaderManager.getLoader(GITHUB_SEARCH_LOADER);
        if(theLoader == null) {
            theLoaderManager.initLoader(GITHUB_SEARCH_LOADER, queryBundler, this);
        }
        else {
            theLoaderManager.restartLoader(GITHUB_SEARCH_LOADER, queryBundler, this);
        }
    }
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            protected void onStartLoading() {
                ...
                // COMPLETED (8) Force a load using forceLoad() !!!
                forceLoad();
                // END - onStartLoading
            }
            ...
            public String loadInBackground() {
                ...
                String theString = args.getString(SEARCH_QUERY_URL_EXTRA);
                ...
                try {
                    URL githubURL = new URL(theString);
