...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String KEY_QUERY_URL = "key_query";

    // COMPLETED (2) Create a static final key to store the search's raw JSON
    private static final String KEY_QUERY_STRING = "key_string";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null) {
            ...
            mSearchResultsTextView.setText(savedInstanceState.getString(KEY_QUERY_STRING));
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String tvUrl = mUrlDisplayTextView.getText().toString();
        outState.putString(KEY_QUERY_URL, tvUrl);
        ...
        String tvJson = mSearchResultsTextView.getText().toString();
        outState.putString(KEY_QUERY_STRING, tvJson);
    }
